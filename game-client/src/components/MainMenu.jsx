        ...
        <div className="flex flex-col items-center justify-center" style={{ width: '50vw', height: '100vh', minWidth: 260, maxWidth: 600 }}>
          ...
          <div className="relative mb-8">
            ...
            <img
              ...
              className="relative z-10 w-32 h-32 mx-auto mb-6 drop-shadow-2xl animate-pulse"
          ...
          <div className="text-center mb-8">
            <h1 className="text-6xl font-bold mb-4 bg-gradient-to-r from-purple-400 via-pink-400 to-orange-400 bg-clip-text text-transparent animate-pulse">
              عوالم السماء
            </h1>
            <h2 className="text-3xl text-gray-300 mb-2 drop-shadow-lg">Skyward Realms</h2>
            <p className="text-lg text-gray-400 mb-6 max-w-md mx-auto leading-relaxed">
          ...
          <div className="flex flex-col gap-4 w-full max-w-sm">
            <Button
              onClick={onStartGame}
              size="lg"
              className="menu-button enhanced group relative overflow-hidden bg-gradient-to-r from-purple-600 via-pink-600 to-orange-600 hover:from-purple-700 hover:via-pink-700 hover:to-orange-700 text-white font-bold py-4 px-8 rounded-2xl transform transition-all duration-300 hover:scale-105 hover:-translate-y-1 shadow-2xl"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              <div className="relative z-10 flex items-center justify-center gap-3">
                <Play className="w-6 h-6 group-hover:scale-110 transition-transform duration-300" />
                <span className="text-lg">ابدأ المغامرة</span>
                <Sword className="w-5 h-5 text-yellow-300 group-hover:rotate-12 transition-transform duration-300" />
              </div>
            </Button>
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="menu-button enhanced group relative overflow-hidden bg-black/30 border-2 border-purple-500/50 text-purple-300 hover:bg-purple-500/20 hover:border-purple-400 font-semibold py-4 px-8 rounded-2xl transition-all duration-300 hover:scale-105 backdrop-blur-sm"
            >
          ...
          <div className="mt-8 grid grid-cols-2 gap-4 w-full max-w-md">
            <div className="bg-black/20 backdrop-blur-sm rounded-xl p-4 border border-purple-500/20 hover:border-purple-500/40 transition-colors duration-300">
              <div className="text-center">
                <div className="w-8 h-8 mx-auto mb-2 bg-gradient-to-r from-red-500 to-orange-500 rounded-full flex items-center justify-center">
                  <span className="text-white text-sm font-bold">🔥</span>
                </div>
                <span className="text-sm text-gray-300">عنصر النار</span>
              </div>
            </div>
            <div className="bg-black/20 backdrop-blur-sm rounded-xl p-4 border border-blue-500/20 hover:border-blue-500/40 transition-colors duration-300">
              <div className="text-center">
                <div className="w-8 h-8 mx-auto mb-2 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full flex items-center justify-center">
                  <span className="text-white text-sm font-bold">💧</span>
                </div>
                <span className="text-sm text-gray-300">عنصر الماء</span>
              </div>
            </div>
            <div className="bg-black/20 backdrop-blur-sm rounded-xl p-4 border border-green-500/20 hover:border-green-500/40 transition-colors duration-300">
              <div className="text-center">
                ...
                <span className="text-sm text-gray-300">عنصر الأرض</span>
              </div>
            </div>
            <div className="bg-black/20 backdrop-blur-sm rounded-xl p-4 border border-gray-400/20 hover:border-gray-400/40 transition-colors duration-300">
              <div className="text-center">
                <div className="w-8 h-8 mx-auto mb-2 bg-gradient-to-r from-gray-400 to-blue-300 rounded-full flex items-center justify-center">
                  <span className="text-white text-sm font-bold">💨</span>
                </div>
                <span className="text-sm text-gray-300">عنصر الهواء</span>
              </div>
            </div>
          </div>
        </div>
